...
While this does work, I shortly afterward realized that I could just use Automation to simultaneousl create a uint[] array for the contract to use, _and_ a JSON string for the game to use, which is altogether a much simpler solution. 
